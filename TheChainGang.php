...
// $officialTokens = array("Token" => "TXXXXX", "Vote" => "A4330178176633399300"); // Original Official Tokens

$officialTokens = array(
	"Token" => "TheChainGang", 
	"Vote" => "A11035732284319710000"
);
$startBlock = 340000; //starting block reference.
